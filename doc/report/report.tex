...
The library produced provides a simple interface for building networks of large numbers of nodes and routing messages between them, the networks it builds are self organising and are resilient against failures of individual nodes in them. It uses Asynchronous I/O for network communication allowing for high scalability.
