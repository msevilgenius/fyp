...
Another aspect of the system tested in this way was failure tolerance. By setting up a network then manually terminating instances and retesting the routing of messages, I was able to verify that the network can manage failures and repair its routing infrastructure.
